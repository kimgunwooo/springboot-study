...
import com.springboot.myproject.data.dto.ChangeProductNameDto;
import com.springboot.myproject.data.dto.ProductDto;
import com.springboot.myproject.data.dto.ProductResponseDto;
import com.springboot.myproject.service.impl.ProductServiceImpl;
...
public class ProductControllerTest {
    ...
    void changeProductNameTest() throws Exception{
        given(productService.changeProductName(1234L,"pen"))
                .willReturn(new ProductResponseDto(1234L,"pen",5000,2000));
        ...
        verify(productService).changeProductName(1234L,"pen");
    }
}
